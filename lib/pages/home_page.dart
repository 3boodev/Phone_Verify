...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    super.initState();
    final data = Provider.of<PhoneData>(context, listen: false);
    data.fetchData(context);
    num_controller = TextEditingController(text: data.number);
  }
  @override
  void dispose() {
        ...
        child: Column(
          children: [
            ...
            Column(
              ...
              children: [
                const Text('The Phone is Valid',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,),),
